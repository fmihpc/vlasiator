...
struct Parameters {
  ...
  static bool sparse_conserve_mass; /*!< If true, density is scaled to conserve mass when removing blocks*/
   ...
   static Real loadBalanceAlpha; /*!< alpha in cell load balance weight = gamma + blocks * alpha */
   static Real loadBalanceGamma; /*!< gamma icell load balance weight = gamma + blocks * alpha */
