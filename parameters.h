...
struct Parameters {
   ...
   static Real CFLlimit;             /**< The maximum CFL limit for propagation. Used to set timestep if useCFLlimit is true. Also used to set number of acceleration steps if substepAcceleration is true */
