...
void initializeDataReducers(DataReducer* outputReducer, DataReducer* diagnosticReducer) {
   ...
   for (it = P::outputVariableList.begin(); it != P::outputVariableList.end(); it++) {
      ...
      */
            ...
            for (int z = 0; z < gridSize[2]; z++) {
               for (int y = 0; y < gridSize[1]; y++) {
                  for (int x = 0; x < gridSize[0]; x++) {
                     retval[3 * (gridSize[1] * gridSize[0] * z + gridSize[0] * y + x)] = (*BgBGrid.get(x, y, z))[fsgrids::BGBX] + (*perBGrid.get(x, y, z))[fsgrids::PERBX];
                     retval[3 * (gridSize[1] * gridSize[0] * z + gridSize[0] * y + x) + 1] = (*BgBGrid.get(x, y, z))[fsgrids::BGBY] + (*perBGrid.get(x, y, z))[fsgrids::PERBY];
                     retval[3 * (gridSize[1] * gridSize[0] * z + gridSize[0] * y + x) + 2] = (*BgBGrid.get(x, y, z))[fsgrids::BGBZ] + (*perBGrid.get(x, y, z))[fsgrids::PERBZ];
                  }
               }
            }
            return retval;
      ...
      if (P::systemWriteAllDROs || lowercase == "populations_moments_backstream" || lowercase == "populations_moments_nonthermal" ||
      ...
      if (P::systemWriteAllDROs || lowercase == "populations_moments_nonbackstream" || lowercase == "populations_moments_thermal" ||
          lowercase == "populations_vg_moments_thermal") { // Per-population moments of the non-backstreaming (thermal?) part.
         for (unsigned int i = 0; i < getObjectWrapper().particleSpecies.size(); i++) {
            species::Species& species = getObjectWrapper().particleSpecies[i];
            const std::string& pop = species.name;
      ...
      if (P::systemWriteAllDROs || lowercase == "populations_precipitationflux" || lowercase == "populations_vg_precipitationdifferentialflux" ||
      ...
      if (P::systemWriteAllDROs || lowercase == "populations_precipitationlineflux" || lowercase == "populations_vg_precipitationlinedifferentialflux" ||
      ...
      if (P::systemWriteAllDROs || lowercase == "halle" || lowercase == "fg_halle" || lowercase == "fg_e_hall") {
         for (int index = 0; index < fsgrids::N_EHALL; index++) {
            ...
            outputReducer->addOperator(new DRO::DataReductionOperatorFsGrid(reducer_name,
      ...
      if (P::systemWriteAllDROs || lowercase == "fg_volb" || lowercase == "fg_bvol" || lowercase == "fg_b_vol") { // Static (typically dipole) magnetic field part
         outputReducer->addOperator(new DRO::DataReductionOperatorFsGrid("fg_b_vol",
            ...
            for (int z = 0; z < gridSize[2]; z++) {
               for (int y = 0; y < gridSize[1]; y++) {
                  for (int x = 0; x < gridSize[0]; x++) {
                     retval[3 * (gridSize[1] * gridSize[0] * z + gridSize[0] * y + x)] = (*BgBGrid.get(x, y, z))[fsgrids::BGBXVOL] + (*volGrid.get(x, y, z))[fsgrids::PERBXVOL];
                     retval[3 * (gridSize[1] * gridSize[0] * z + gridSize[0] * y + x) + 1] = (*BgBGrid.get(x, y, z))[fsgrids::BGBYVOL] + (*volGrid.get(x, y, z))[fsgrids::PERBYVOL];
                     retval[3 * (gridSize[1] * gridSize[0] * z + gridSize[0] * y + x) + 2] = (*BgBGrid.get(x, y, z))[fsgrids::BGBZVOL] + (*volGrid.get(x, y, z))[fsgrids::PERBZVOL];
                  }
               }
            }
            return retval;
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_latitude") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_latitude", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_chi0") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_chi0", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_cellarea") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereElement("ig_cellarea", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_b") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_b", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_e") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereElement("ig_e", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_inplanecurrent") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereElement("ig_inplanecurrent", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.elements.size() * 3);
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_upmappedarea") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereElement("ig_upmappedarea", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.elements.size() * 3);
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_sigmap") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_sigmap", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_sigmah") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_sigmah", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_sigmaparallel") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_sigmaparallel", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_rhon") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_rhon", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_electrontemp") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_electrontemp", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_deltaphi") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_deltaphi", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_precipitation") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_precipitation", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
         ...
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_precipnumflux", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            ...
            for (uint i = 0; i < grid.nodes.size(); i++) {
               ...
               for (int p = 0; p < SBC::productionNumParticleEnergies; p++) {
                  ...
                  retval[i] += grid.nodes[i].parameters[ionosphereParameters::RHON] * sqrt(1. / (2. * M_PI * physicalconstants::MASS_ELECTRON)) * particle_energy[p] / temp_keV /
                               sqrt(temp_keV * 1e3 * physicalconstants::CHARGE) * deltaE * exp(-energyparam); // Flux 1/m^2/s
               }
            }
            return retval;
         }));
         ...
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_precipavgenergy", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            ...
            for (uint i = 0; i < grid.nodes.size(); i++) {
               ...
               for (int p = 0; p < SBC::productionNumParticleEnergies; p++) {
                  Real energyparam = (particle_energy[p] - accenergy) / temp_keV;                                // = E_p / (kB T)
                  Real deltaE = (particle_energy[p + 1] - particle_energy[p]) * 1e3 * physicalconstants::CHARGE; // dE in J
                  numberFlux += grid.nodes[i].parameters[ionosphereParameters::RHON] * sqrt(1. / (2. * M_PI * physicalconstants::MASS_ELECTRON)) * particle_energy[p] / temp_keV /
                                sqrt(temp_keV * 1e3 * physicalconstants::CHARGE) * deltaE * exp(-energyparam); // Flux 1/m^2/s
               }
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_potential") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_potential", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_solverinternals") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_source", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
         ...
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_residual", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
         ...
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_p", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
         ...
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_pp", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
         ...
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_z", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
         ...
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_zz", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_upmappednodecoords") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_upmappednodecoords", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size() * 3);
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_upmappedb") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_upmappedb", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size() * 3);
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_openclosed") {
         ...
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_openclosed", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
      ...
      if (P::systemWriteAllDROs || lowercase == "ig_fac") {
         outputReducer->addOperator(new DRO::DataReductionOperatorIonosphereNode("ig_fac", [](SBC::SphericalTriGrid& grid) -> std::vector<Real> {
            std::vector<Real> retval(grid.nodes.size());
      ...
      if (P::systemWriteAllDROs || lowercase == "vg_ionospherecoupling") {
         outputReducer->addOperator(new DRO::DataReductionOperatorMPIGridCell("vg_ionospherecoupling", 3, [](const SpatialCell* cell) -> std::vector<Real> {
   ...
   for (it = P::diagnosticVariableList.begin(); it != P::diagnosticVariableList.end(); it++) {
      ...
      if (P::diagnosticWriteAllDROs || lowercase == "lbweight" || lowercase == "vg_lbweight" || lowercase == "vg_loadbalanceweight" || lowercase == "vg_loadbalance_weight" ||
 ...
 */
bool DataReducer::writeFsGridData(FsGrid<std::array<Real, fsgrids::bfield::N_BFIELD>, FS_STENCIL_WIDTH>& perBGrid, FsGrid<std::array<Real, fsgrids::efield::N_EFIELD>, FS_STENCIL_WIDTH>& EGrid,
                                  ...
                                  FsGrid<fsgrids::technical, FS_STENCIL_WIDTH>& technicalGrid, const std::string& meshName, const unsigned int operatorID, vlsv::Writer& vlsvWriter,
...
bool DataReducer::writeIonosphereGridData(SBC::SphericalTriGrid& grid, const std::string& meshName, const unsigned int operatorID, vlsv::Writer& vlsvWriter) {
