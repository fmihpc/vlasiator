...
bool P::addParameters() {
   ...
   RP::add("fieldtracing.fullbox_max_incomplete_fieldlines", "Maximum fraction of field lines left incomplete when stopping tracing loop. Defaults to zero to process all, will be slow at scale!", 0);
   RP::add("fieldtracing.fluxrope_max_incomplete_fieldlines", "Maximum fraction of field lines left incomplete when stopping tracing loop. Defaults to zero to process all, will be slow at scale!", 0);
   ...
   RP::add("fieldtracing.fluxrope_max_valid_curvature_radius", "Maximum curvature radius allowed to even begin tracing to find flux ropes, safeguard for areas with very large curvature radii (m)", 1e8);
...
void Parameters::getParameters() {
   ...
   RP::get("fieldtracing.fullbox_max_incomplete_fieldlines", FieldTracing::fieldTracingParameters.fullbox_max_incomplete_lines);
   RP::get("fieldtracing.fluxrope_max_incomplete_fieldlines", FieldTracing::fieldTracingParameters.fluxrope_max_incomplete_lines);
   ...
   RP::get("fieldtracing.fluxrope_max_valid_curvature_radius", FieldTracing::fieldTracingParameters.fluxrope_max_valid_curvature_radius);
