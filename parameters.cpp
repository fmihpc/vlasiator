...
bool P::addParameters() {
   ...
   RP::add("gridbuilder.timeclassExactHaloExtent", "Exact halo extent for timeclass halos", 0);
   RP::add("gridbuilder.timeclassOuterHaloExtent", "Outer halo extent for timeclass halos", 0);
