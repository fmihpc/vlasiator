...
Real P::noRefinementUnderX = -LARGE_REAL;
Real P::noRefinementUnderY = -LARGE_REAL;
Real P::noRefinementUnderZ = -LARGE_REAL;
Real P::noRefinementOverX = LARGE_REAL;
Real P::noRefinementOverY = LARGE_REAL;
Real P::noRefinementOverZ = LARGE_REAL;
...
bool P::addParameters() {
   ...
   RP::add("AMR.no_refinement_under_x", "Refinement minimum X coordinate, no refinement at x < this value (m)", -LARGE_REAL);
   RP::add("AMR.no_refinement_under_y", "Refinement minimum Y coordinate, no refinement at y < this value (m)", -LARGE_REAL);
   RP::add("AMR.no_refinement_under_z", "Refinement minimum Z coordinate, no refinement at z < this value (m)", -LARGE_REAL);
   RP::add("AMR.no_refinement_over_x", "Refinement maximum X coordinate, no refinement at x > this value (m)", LARGE_REAL);
   RP::add("AMR.no_refinement_over_y", "Refinement maximum Y coordinate, no refinement at y > this value (m)", LARGE_REAL);
   RP::add("AMR.no_refinement_over_z", "Refinement maximum Z coordinate, no refinement at z > this value (m)", LARGE_REAL);
...
void Parameters::getParameters() {
   ...
   RP::get("AMR.no_refinement_under_x", P::noRefinementUnderX);
   RP::get("AMR.no_refinement_under_y", P::noRefinementUnderY);
   RP::get("AMR.no_refinement_under_z", P::noRefinementUnderZ);
   RP::get("AMR.no_refinement_over_x", P::noRefinementOverX);
   RP::get("AMR.no_refinement_over_y", P::noRefinementOverY);
   RP::get("AMR.no_refinement_over_z", P::noRefinementOverZ);
