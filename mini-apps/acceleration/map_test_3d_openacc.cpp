...
void propagate(const Real * const values_in, Real *values_out, 
  ...
  #pragma acc enter data create(values_out[:(blocks_per_dim_z+2) * blocks_per_dim_x * blocks_per_dim_z * WID3]) copyin(values_in[:(blocks_per_dim_z+2) * blocks_per_dim_x * blocks_per_dim_z * WID3])
  ...
  #pragma acc parallel loop collapse(2) present(values_out[:(blocks_per_dim_z+2) * blocks_per_dim_x * blocks_per_dim_z * WID3])
  ...
  #pragma acc exit data copyout(values_out[:(blocks_per_dim_z+2) * blocks_per_dim_x * blocks_per_dim_z * WID3]) delete(values_in[:(blocks_per_dim_z+2) * blocks_per_dim_x * blocks_per_dim_z * WID3])
}
