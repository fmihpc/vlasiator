...
bool P::addParameters() {
   ...
   RP::addComposing("variables_deprecated.output",
                    string() + "List of deprecated names for data reduction operators (DROs). Names are case insensitive. " +
                        "Available (20250413): " + "B BackgroundB fg_BackgroundB PerturbedB fg_PerturbedB " + "E " + "Rhom Rhoq populations_Rho " + "V populations_V " +
                        "populations_moments_Backstream populations_moments_NonBackstream " + "populations_moments_thermal populations_moments_nonthermal " +
                        ...
                        "populations_maxdt_acceleration populations_maxdt_translation MaxFieldsdt fg_maxfieldsdt" + "MPIrank FsGridRank " +
                        "FsGridBoundaryType BoundaryType FsGridBoundaryLayer BoundaryLayer " + "populations_Blocks fSaved vg_fsaved" + "populations_accSubcycles populations_acceleration_subcycles" +
                        "VolE vg_VolE Evol E_vol fg_VolE fg_Evol " + "HallE fg_HallE GradPeE e_gradpe VolB vg_VolB fg_VolB B_vol Bvol vg_Bvol fg_volB fg_Bvol " + "BackgroundVolB PerturbedVolB " +
                        "Pressure vg_Pressure fg_Pressure populations_PTensor " + "BVOLderivs b_vol_derivs");
   ...
   RP::addComposing("variables_deprecated.diagnostic",
                    string() +
                        ...
                        "Available (20250130): " + "rhom populations_rholossadjust populations_rho_loss_adjust " + "populations_blocks lbweight loadbalance_weight " +
                        "vg_lbweight vg_loadbalanceweight " + "maxvdt maxdt_acceleration " + "maxrdt maxdt_translation " + "populations_maxvdt populations_maxrdt " +
                        "populations_maxdt_acceleration populations_maxdt_translation " + "maxfieldsdt maxdt_fieldsolver fg_maxfieldsdt");
   ...
   RP::add("AMR.number_of_refine_boxes",
           "How many boxes outside which to suppress refinement, that number of box edges have to then be defined as well. If more than 1 box is defined, refinement is suppressed outside the union "
           "of the volumes of all boxes.",
           0);
