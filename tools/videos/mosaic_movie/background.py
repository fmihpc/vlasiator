...
dotsFile = "ACB_background_dots_50_2664x2332.png"
outputLocation = "/home/kempf/Servers/stornext_vlasiator/visualizations/ACB/mosaics_tmp3/"
fileName = "ACB_background_rho_dotted_50_2664x2332_"

timeList = range(573,574)
for time in timeList:
   number=str(time).rjust(7, '0')
   fileLocation = "voima:/lustre/tmp/alfthan/2D/ACB_yk/bulk."+number+".vlsv"
   ...
   ThresholdAtts.defaultVarName = "Boundary_type"
   ...
   PseudocolorAtts.min = 1e5
   PseudocolorAtts.maxFlag = 1
   PseudocolorAtts.max = 2e7
   ...
   subprocess.call(["convert", SaveWindowAtts.fileName+".png", dotsFile, "-composite", SaveWindowAtts.fileName+".png"])
