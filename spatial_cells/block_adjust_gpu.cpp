...
namespace spatial_cell {
   ...
   void update_velocity_block_content_lists(dccrg::Dccrg<spatial_cell::SpatialCell, dccrg::Cartesian_Geometry>& mpiGrid, const vector<CellID>& cells, const uint popID = 0);

   void adjust_velocity_blocks_in_cells(dccrg::Dccrg<spatial_cell::SpatialCell, dccrg::Cartesian_Geometry>& mpiGrid, const vector<CellID>& cells, const uint popID = 0);

   void clear_maps_caller(const uint nCells, const size_t largestSizePower, gpuStream_t stream = 0, const size_t offset = 0);

   void batch_adjust_blocks_caller(dccrg::Dccrg<spatial_cell::SpatialCell, dccrg::Cartesian_Geometry>& mpiGrid, const vector<CellID>& cellsToAdjust, const uint cellOffset, uint& largestBlocksToChange,
                                   uint& largestBlocksBeforeOrAfter, const uint popID = 0);
