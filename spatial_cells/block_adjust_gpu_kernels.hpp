...
__global__ void __launch_bounds__(Hashinator::defaults::MAX_BLOCKSIZE, FULLBLOCKS_PER_MP) check_vector_capacities(
   const Hashinator::Hashmap<vmesh::GlobalID, vmesh::LocalID>* __restrict__ const* maps, const split::SplitVector<vmesh::GlobalID>* __restrict__ const* vecs, vmesh::LocalID* required_capacities
) {
