...
__global__ void __launch_bounds__(WID3, 4) update_velocity_block_content_lists_kernel(const vmesh::VelocityMesh* __restrict__ vmesh, const vmesh::VelocityBlockContainer* __restrict__ blockContainer,
                                                                                      Hashinator::Hashmap<vmesh::GlobalID, vmesh::LocalID>* vbwcl_map,
                                                                                      Hashinator::Hashmap<vmesh::GlobalID, vmesh::LocalID>* vbwncl_map, const Real velocity_block_min_value) {
 ...
 */
//__launch_bounds__(GPUTHREADS,4)
__global__ void update_neighbour_halo_kernel(const vmesh::VelocityMesh* __restrict__ vmesh, const uint neighbour_count, const vmesh::GlobalID* __restrict__ const* dev_neigh_vbwcls,
                                             const vmesh::LocalID* __restrict__ dev_neigh_Nvbwcls, Hashinator::Hashmap<vmesh::GlobalID, vmesh::LocalID>* dev_velocity_block_with_content_map,
                                             Hashinator::Hashmap<vmesh::GlobalID, vmesh::LocalID>* dev_velocity_block_with_no_content_map) {
 ...
 */
__global__ void update_vmesh_and_blockparameters_kernel(vmesh::VelocityMesh* dev_vmesh, vmesh::VelocityBlockContainer* dev_blockContainer,
...
__global__ void resize_vbc_kernel_pre(vmesh::VelocityMesh* vmesh, vmesh::VelocityBlockContainer* blockContainer, const split::SplitVector<vmesh::GlobalID>* __restrict__ list_with_replace_new,
...
__global__ void __launch_bounds__(WID3, 4)
    update_velocity_blocks_kernel(vmesh::VelocityMesh* vmesh, vmesh::VelocityBlockContainer* blockContainer, const split::SplitVector<vmesh::GlobalID>* __restrict__ list_with_replace_new,
                                  const split::SplitVector<Hashinator::hash_pair<vmesh::GlobalID, vmesh::LocalID>>* __restrict__ list_delete,
                                  const split::SplitVector<Hashinator::hash_pair<vmesh::GlobalID, vmesh::LocalID>>* __restrict__ list_to_replace,
                                  const split::SplitVector<Hashinator::hash_pair<vmesh::GlobalID, vmesh::LocalID>>* __restrict__ list_with_replace_old, const vmesh::LocalID nBlocksBeforeAdjust,
                                  const vmesh::LocalID nBlocksToChange, const vmesh::LocalID nBlocksAfterAdjust, Realf* gpu_rhoLossAdjust) {
   // const int gpuBlocks = gridDim.x;
   // const int blocki = blockIdx.x;
