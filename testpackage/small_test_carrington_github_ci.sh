...
run_command="mpirun --map-by ppr:$SLURM_NTASKSE:node:PE=$OMP_NUM_THREADS --bind-to core --report-bindings --mca btl self -mca pml ^vader,tcp,openib,uct,yalla -x UCX_NET_DEVICES=mlx5_0:1 -x UCX_TLS=rc,sm -x UCX_IB_ADDR_TYPE=ib_global -np $tasks"
