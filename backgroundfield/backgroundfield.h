...
*/
template <long unsigned int numFields> void
setPerturbedField(const FieldFunction& bfFunction, FsGrid<std::array<Real, numFields>, FS_STENCIL_WIDTH>& BGrid, int offset = fsgrids::bfield::PERBX, bool append = false) {
