...
*/
void updateRemoteVelocityBlockLists(dccrg::Dccrg<SpatialCell, dccrg::Cartesian_Geometry>& mpiGrid, const uint popID, const uint neighborhood /*=Neighborhoods::DIST_FUNC default*/
) {
   SpatialCell::setCommunicatedSpecies(popID);
