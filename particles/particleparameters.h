...
struct ParticleParameters {
   ...
   static Real reflect_start_y;  /*!< Y-Coordinate of the bottom end of the parabola, at which shock reflection scenario
                                    particles are injected */
   static Real reflect_stop_y;   /*!< Y-Coordinate of the top end of the parabola, at which shock reflection scenario
                                    particles are injected */
   ...
   static Real reflect_upstream_boundary;   /*!< Distance from particle injection point at which particles are to be
                                               counted as 'reflected' */
   static Real reflect_downstream_boundary; /*!< Distance from particle injection point at which particles are to be
   ...
   static Distribution* (*distribution)(
       std::default_random_engine&); /*!< Type of distribution from which to sample the particles */
