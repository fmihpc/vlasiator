...
bool ParticleParameters::addParameters() {
   ...
   Readparameters::add("particles.ipshock_inject_x0", "X-Coordinate of the lower edge of particle injection region for the ipShock scenario", -1.e6);
   Readparameters::add("particles.ipshock_inject_x1", "X-Coordinate of the upper edge of particle injection region for the ipShock scenario", 1.e6);
   Readparameters::add("particles.ipshock_inject_y0", "Y-Coordinate of the lower edge of particle injection region for the ipShock scenario", -1.e6);
   Readparameters::add("particles.ipshock_inject_y1", "Y-Coordinate of the upper edge of particle injection region for the ipShock scenario", 1.e6);
   Readparameters::add("particles.ipshock_inject_z0", "Z-Coordinate of the lower edge of particle injection region for the ipShock scenario", -1.e6);
   Readparameters::add("particles.ipshock_inject_z1", "Z-Coordinate of the upper edge of particle injection region for the ipShock scenario", 1.e6);
   Readparameters::add("particles.ipshock_transmit", "X-Coordinate of threshold for where particles are counted  as transmitted for the ipShock scenario", -10.e6);
   Readparameters::add("particles.ipshock_reflect", "X-Coordinate of threshold for where particles are counted  as reflected for the ipShock scenario", 10.e6);
