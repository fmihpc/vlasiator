...
void singleParticleScenario::afterPush(int step, double time, ParticleContainer& particles, Field& E, Field& B, Field& V) {
...
void distributionScenario::newTimestep(int input_file_counter, int step, double time, ParticleContainer& particles, Field& E, Field& B, Field& V) {
...
void distributionScenario::finalize(ParticleContainer& particles, Field& E, Field& B, Field& V) { writeParticles(particles, "particles_final.vlsv"); }

void precipitationScenario::afterPush(int step, double time, ParticleContainer& particles, Field& E, Field& B, Field& V) {
   ...
   for (unsigned int i = 0; i < particles.size(); i++) {
      ...
      double start_pos = ParticleParameters::precip_start_x +
                         ((double)(i % ParticleParameters::num_particles)) / ParticleParameters::num_particles * (ParticleParameters::precip_stop_x - ParticleParameters::precip_start_x);
...
void precipitationScenario::newTimestep(int input_file_counter, int step, double time, ParticleContainer& particles, Field& E, Field& B, Field& V) {
...
ParticleContainer analysatorScenario::initialParticles(Field& E, Field& B, Field& V) {
   ...
   std::cerr << "Reading initial particle data from stdin" << std::endl << "(format: x y z vx vy vz)" << std::endl;
...
void analysatorScenario::newTimestep(int input_file_counter, int step, double time, ParticleContainer& particles, Field& E, Field& B, Field& V) {
...
void shockReflectivityScenario::newTimestep(int input_file_counter, int step, double time, ParticleContainer& particles, Field& E, Field& B, Field& V) {
...
void shockReflectivityScenario::afterPush(int step, double time, ParticleContainer& particles, Field& E, Field& B, Field& V) {
...
void ipShockScenario::newTimestep(int input_file_counter, int step, double time, ParticleContainer& particles, Field& E, Field& B, Field& V) {
...
void ipShockScenario::afterPush(int step, double time, ParticleContainer& particles, Field& E, Field& B, Field& V) {
