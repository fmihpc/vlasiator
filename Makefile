...
OBJS = 	version.o memoryallocation.o backgroundfield.o quadr.o dipole.o linedipole.o vectordipole.o constantfield.o integratefunction.o \
	...
	donotcompute.o ionosphere.o outflow.o inflow.o user.o maxwellian.o\
...
inflow.o: ${DEPS_SYSBOUND} sysboundary/inflow.h sysboundary/inflow.cpp sysboundary/user.h sysboundary/user.cpp
	${CMP} ${CXXFLAGS} ${FLAGS} ${MATHFLAGS} -c sysboundary/inflow.cpp ${INC_DCCRG} ${INC_FSGRID} ${INC_ZOLTAN} ${INC_BOOST} ${INC_EIGEN}

maxwellian.o: ${DEPS_SYSBOUND} sysboundary/maxwellian.h sysboundary/maxwellian.cpp sysboundary/user.h sysboundary/user.cpp sysboundary/inflow.cpp
...
sysboundary.o: ${DEPS_COMMON} sysboundary/sysboundary.h sysboundary/sysboundary.cpp sysboundary/sysboundarycondition.h sysboundary/sysboundarycondition.cpp sysboundary/donotcompute.h sysboundary/donotcompute.cpp sysboundary/ionosphere.h sysboundary/ionosphere.cpp sysboundary/outflow.h sysboundary/outflow.cpp sysboundary/inflow.h sysboundary/inflow.cpp sysboundary/maxwellian.h sysboundary/maxwellian.cpp sysboundary/user.h sysboundary/user.cpp
	${CMP} ${CXXFLAGS} ${FLAGS} ${MATHFLAGS} -c sysboundary/sysboundary.cpp ${INC_DCCRG} ${INC_FSGRID} ${INC_ZOLTAN} ${INC_BOOST} ${INC_EIGEN} 

sysboundarycondition.o: ${DEPS_COMMON} sysboundary/sysboundarycondition.h sysboundary/sysboundarycondition.cpp sysboundary/donotcompute.h sysboundary/donotcompute.cpp sysboundary/ionosphere.h sysboundary/ionosphere.cpp sysboundary/outflow.h sysboundary/inflow.h sysboundary/inflow.cpp sysboundary/outflow.cpp sysboundary/maxwellian.h sysboundary/maxwellian.cpp sysboundary/user.h sysboundary/user.cpp
