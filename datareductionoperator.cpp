...
namespace DRO {
   ...
   // B_FACEX
   VariableB_FACEX::VariableB_FACEX(): DataReductionOperator() { }
   VariableB_FACEX::~VariableB_FACEX() { }
   
   bool VariableB_FACEX::getDataVectorInfo(std::string& dataType,unsigned int& dataSize,unsigned int& vectorSize) const {
      dataType = "float";
      dataSize =  sizeof(Real);
      vectorSize = 3;
      return true;
   ...
   std::string VariableB_FACEX::getName() const {return "B_FACEX";}
   
   bool VariableB_FACEX::reduceData(const SpatialCell* cell,char* buffer) {
      const char* ptr = reinterpret_cast<const char*>(B);
      for (uint i=0; i<3*sizeof(Real); ++i) buffer[i] = ptr[i];
      return true;
   }
   
   bool VariableB_FACEX::setSpatialCell(const SpatialCell* cell) {
      B  = &(cell->parameters[CellParams::BXFACEX]);
      return true;
   }
   
   // B_FACEY
   VariableB_FACEY::VariableB_FACEY(): DataReductionOperator() { }
   VariableB_FACEY::~VariableB_FACEY() { }
   
   bool VariableB_FACEY::getDataVectorInfo(std::string& dataType,unsigned int& dataSize,unsigned int& vectorSize) const {
      dataType = "float";
      dataSize =  sizeof(Real);
      vectorSize = 3;
      return true;
   ...
   std::string VariableB_FACEY::getName() const {return "B_FACEY";}
   
   bool VariableB_FACEY::reduceData(const SpatialCell* cell,char* buffer) {
      const char* ptr = reinterpret_cast<const char*>(B);
      for (uint i=0; i<3*sizeof(Real); ++i) buffer[i] = ptr[i];
      return true;
   }
   
   bool VariableB_FACEY::setSpatialCell(const SpatialCell* cell) {
      B  = &(cell->parameters[CellParams::BXFACEY]);
      return true;
   }
   
   // B_FACEZ
   VariableB_FACEZ::VariableB_FACEZ(): DataReductionOperator() { }
   VariableB_FACEZ::~VariableB_FACEZ() { }
   
   bool VariableB_FACEZ::getDataVectorInfo(std::string& dataType,unsigned int& dataSize,unsigned int& vectorSize) const {
      dataType = "float";
      dataSize =  sizeof(Real);
      vectorSize = 3;
      return true;
   ...
   std::string VariableB_FACEZ::getName() const {return "B_FACEZ";}
   
   bool VariableB_FACEZ::reduceData(const SpatialCell* cell,char* buffer) {
      const char* ptr = reinterpret_cast<const char*>(B);
      for (uint i=0; i<3*sizeof(Real); ++i) buffer[i] = ptr[i];
      return true;
   }
   
   bool VariableB_FACEZ::setSpatialCell(const SpatialCell* cell) {
      B  = &(cell->parameters[CellParams::BXFACEZ]);
      return true;
   }
