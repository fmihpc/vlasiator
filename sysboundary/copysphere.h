...
namespace SBC {
   ...
   void DoNotCompute::initSysBoundary(creal& t, Project& project) {
      precedence = 0;
      dynamic = false;
   }

   void DoNotCompute::assignSysBoundary(dccrg::Dccrg<SpatialCell, dccrg::Cartesian_Geometry>&, FsGrid<fsgrids::technical, FS_STENCIL_WIDTH>& technicalGrid) {
      // Does nothing.
   }

   void DoNotCompute::applyInitialState(dccrg::Dccrg<SpatialCell, dccrg::Cartesian_Geometry>& mpiGrid, FsGrid<fsgrids::technical, FS_STENCIL_WIDTH>& technicalGrid,
...
#pragma omp parallel for
   ...
   void DoNotCompute::updateState(dccrg::Dccrg<SpatialCell, dccrg::Cartesian_Geometry>& mpiGrid, FsGrid<std::array<Real, fsgrids::bfield::N_BFIELD>, FS_STENCIL_WIDTH>& perBGrid,
