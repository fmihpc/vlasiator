 ...
 *
 * Copysphere is a class handling cells tagged as sysboundarytype::COPYSPHERE by this system boundary condition. It
 * applies copy boundary conditions to perturbed magnetic field.
 *
 * These consist in:
...
protected:
   ...
   uint geometry;  /*!< Geometry of the copy sphere, 0: inf-norm (diamond), 1: 1-norm (square), 2: 2-norm (circle,
