...
namespace SBC {
/*!\brief SBC::SysBoundaryCondition is the base class for boundary conditions.
 *
 * SBC::SysBoundaryCondition defines a base class for applying boundary
 ...
 *
 * If needed, a user can write his or her own SBC::BoundaryConditions, which
