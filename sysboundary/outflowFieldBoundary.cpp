...
namespace SBC {
   void OutflowFieldBoundary::fieldSolverBoundaryCondMagneticFieldProjection(
   ...
   void OutflowFieldBoundary::fieldSolverBoundaryCondElectricField(
   ...
   void OutflowFieldBoundary::fieldSolverBoundaryCondHallElectricField(
   ...
   void OutflowFieldBoundary::fieldSolverBoundaryCondGradPeElectricField(
   ...
   void OutflowFieldBoundary::fieldSolverBoundaryCondDerivatives(
   ...
   void OutflowFieldBoundary::fieldSolverBoundaryCondBVOLDerivatives(
