...
bool ObjectWrapper::addPopulationParameters() {
   ...
   for (auto& pop : popNames) {
      ...
      RP::add(pop + "_sparse.minValue",
              "Minimum value of distribution function in any cell of a velocity block for the block to be considered "
              "to have contents",
              1e-15);
      ...
      Readparameters::add(pop + "_energydensity.limit1",
                          "Lower limit of second bin for energy density, given in units of solar wind ram energy.",
                          5.0);
      Readparameters::add(pop + "_energydensity.limit2",
