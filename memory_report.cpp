 ...
 */
void report_memory_consumption(dccrg::Dccrg<SpatialCell, dccrg::Cartesian_Geometry>& mpiGrid, double extra_bytes /*=0*/
) {
   ...
   if (PAPI_library_init(PAPI_VER_CURRENT) == PAPI_VER_CURRENT) {
      ...
      if (nodeRank == 0) {
         ...
         snprintf(reportstring,
                  ...
                  P::tstep,
                  P::t,
                  "High water mark \U0001F30A   ",
                  sum_mem_papi[0] / nNodes / GiB,
                  min_mem_papi[0] / GiB,
                  max_mem_papi[0] / GiB,
                  sum_mem_papi[0] / GiB,
                  nNodes);
         ...
         if (max_mem_papi[3] != 0.0) {
            snprintf(reportstring,
                     ...
                     P::tstep,
                     P::t,
                     "Resident with refines",
                     sum_mem_papi[1] / nNodes / GiB,
                     min_mem_papi[1] / GiB,
                     max_mem_papi[1] / GiB,
                     sum_mem_papi[1] / GiB,
                     nNodes);
   ...
   snprintf(reportstring,
            ...
            P::tstep,
            P::t,
            "Local cells capacity",
            sum_mem[3] / nProcs / GiB,
            min_mem[0].val / GiB,
            max_mem[0].val / GiB,
            sum_mem[3] / GiB,
            min_mem[0].rank,
   ...
   snprintf(reportstring,
            ...
            P::tstep,
            P::t,
            "Remote cells capacity",
            sum_mem[4] / nProcs / GiB,
            min_mem[1].val / GiB,
            max_mem[1].val / GiB,
            sum_mem[4] / GiB,
            min_mem[1].rank,
   ...
   snprintf(reportstring,
            ...
            P::tstep,
            P::t,
            "Total cells capacity",
            sum_mem[5] / nProcs / GiB,
            min_mem[2].val / GiB,
            max_mem[2].val / GiB,
            sum_mem[5] / GiB,
            min_mem[2].rank,
