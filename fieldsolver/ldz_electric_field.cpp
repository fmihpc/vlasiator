...
void calculateElectricField(FsGrid<std::array<Real, fsgrids::bfield::N_BFIELD>, FS_STENCIL_WIDTH>& perBGrid,
   ...
   if ((bitfield & compute::EX) == compute::EX) {
      calculateEdgeElectricFieldX(perBGrid,
                                  EGrid,
                                  EHallGrid,
                                  EGradPeGrid,
                                  momentsGrid,
   ...
   if ((bitfield & compute::EY) == compute::EY) {
      calculateEdgeElectricFieldY(perBGrid,
                                  EGrid,
                                  EHallGrid,
                                  EGradPeGrid,
                                  momentsGrid,
   ...
   if ((bitfield & compute::EZ) == compute::EZ) {
      calculateEdgeElectricFieldZ(perBGrid,
                                  EGrid,
                                  EHallGrid,
                                  EGradPeGrid,
                                  momentsGrid,
      ...
      for (int k = 0; k < gridDims[2]; k++) {
         for (int j = 0; j < gridDims[1]; j++) {
            for (int i = 0; i < gridDims[0]; i++) {
               if (RKCase == RK_ORDER1 || RKCase == RK_ORDER2_STEP2) {
                  calculateElectricField(perBGrid,
                                         EGrid,
                                         EHallGrid,
                                         EGradPeGrid,
                                         momentsGrid,
                  ...
                  calculateElectricField(perBDt2Grid,
                                         EDt2Grid,
                                         EHallGrid,
                                         EGradPeGrid,
                                         momentsDt2Grid,
