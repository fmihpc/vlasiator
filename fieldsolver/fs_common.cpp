...
void reconstructionCoefficients(FsGrid<std::array<Real, fsgrids::bfield::N_BFIELD>, FS_STENCIL_WIDTH>& perBGrid,
   ...
   if (params->get(i + 1, j, k) != NULL)
      cep_i2j1k1 = params->get(i + 1, j, k);
   if (params->get(i, j + 1, k) != NULL)
      cep_i1j2k1 = params->get(i, j + 1, k);
   if (params->get(i, j, k + 1) != NULL)
      cep_i1j1k2 = params->get(i, j, k + 1);
   ...
   if (dPerBGrid.get(i + 1, j, k) != NULL)
      der_i2j1k1 = dPerBGrid.get(i + 1, j, k);
   if (dPerBGrid.get(i, j + 1, k) != NULL)
      der_i1j2k1 = dPerBGrid.get(i, j + 1, k);
   if (dPerBGrid.get(i, j, k + 1) != NULL)
      der_i1j1k2 = dPerBGrid.get(i, j, k + 1);
   ...
   if (reconstructionOrder == 2) {
      ...
      perturbedResult[Rec::a_yy] =
          HALF * (der_i2j1k1->at(fsgrids::dperb::dPERBxdyy) + der_i1j1k1->at(fsgrids::dperb::dPERBxdyy));
      perturbedResult[Rec::a_zz] =
          HALF * (der_i2j1k1->at(fsgrids::dperb::dPERBxdzz) + der_i1j1k1->at(fsgrids::dperb::dPERBxdzz));
      perturbedResult[Rec::a_yz] =
          HALF * (der_i2j1k1->at(fsgrids::dperb::dPERBxdyz) + der_i1j1k1->at(fsgrids::dperb::dPERBxdyz));
      perturbedResult[Rec::a_xyy] =
          (der_i2j1k1->at(fsgrids::dperb::dPERBxdyy) - der_i1j1k1->at(fsgrids::dperb::dPERBxdyy));
      perturbedResult[Rec::a_xyz] =
          (der_i2j1k1->at(fsgrids::dperb::dPERBxdyz) - der_i1j1k1->at(fsgrids::dperb::dPERBxdyz));
      perturbedResult[Rec::a_xzz] =
          (der_i2j1k1->at(fsgrids::dperb::dPERBxdzz) - der_i1j1k1->at(fsgrids::dperb::dPERBxdzz));

      perturbedResult[Rec::b_xx] =
          HALF * (der_i1j2k1->at(fsgrids::dperb::dPERBydxx) + der_i1j1k1->at(fsgrids::dperb::dPERBydxx));
      perturbedResult[Rec::b_xz] =
          HALF * (der_i1j2k1->at(fsgrids::dperb::dPERBydxz) + der_i1j1k1->at(fsgrids::dperb::dPERBydxz));
      perturbedResult[Rec::b_zz] =
          HALF * (der_i1j2k1->at(fsgrids::dperb::dPERBydzz) + der_i1j1k1->at(fsgrids::dperb::dPERBydzz));
      perturbedResult[Rec::b_xxy] =
          (der_i1j2k1->at(fsgrids::dperb::dPERBydxx) - der_i1j1k1->at(fsgrids::dperb::dPERBydxx));
      perturbedResult[Rec::b_xyz] =
          (der_i1j2k1->at(fsgrids::dperb::dPERBydxz) - der_i1j1k1->at(fsgrids::dperb::dPERBydxz));
      perturbedResult[Rec::b_yzz] =
          (der_i1j2k1->at(fsgrids::dperb::dPERBydzz) - der_i1j1k1->at(fsgrids::dperb::dPERBydzz));

      perturbedResult[Rec::c_xx] =
          HALF * (der_i1j1k2->at(fsgrids::dperb::dPERBzdxx) + der_i1j1k1->at(fsgrids::dperb::dPERBzdxx));
      perturbedResult[Rec::c_xy] =
          HALF * (der_i1j1k2->at(fsgrids::dperb::dPERBzdxy) + der_i1j1k1->at(fsgrids::dperb::dPERBzdxy));
      perturbedResult[Rec::c_yy] =
          HALF * (der_i1j1k2->at(fsgrids::dperb::dPERBzdyy) + der_i1j1k1->at(fsgrids::dperb::dPERBzdyy));
      perturbedResult[Rec::c_xxz] =
          (der_i1j1k2->at(fsgrids::dperb::dPERBzdxx) - der_i1j1k1->at(fsgrids::dperb::dPERBzdxx));
      perturbedResult[Rec::c_xyz] =
          (der_i1j1k2->at(fsgrids::dperb::dPERBzdxy) - der_i1j1k1->at(fsgrids::dperb::dPERBzdxy));
      perturbedResult[Rec::c_yyz] =
          (der_i1j1k2->at(fsgrids::dperb::dPERBzdyy) - der_i1j1k1->at(fsgrids::dperb::dPERBzdyy));
   ...
   perturbedResult[Rec::a_y] =
       HALF * (der_i2j1k1->at(fsgrids::dperb::dPERBxdy) + der_i1j1k1->at(fsgrids::dperb::dPERBxdy)) -
       SIXTH * perturbedResult[Rec::a_xxy];
   perturbedResult[Rec::a_z] =
       HALF * (der_i2j1k1->at(fsgrids::dperb::dPERBxdz) + der_i1j1k1->at(fsgrids::dperb::dPERBxdz)) -
   ...
   perturbedResult[Rec::b_x] =
       HALF * (der_i1j2k1->at(fsgrids::dperb::dPERBydx) + der_i1j1k1->at(fsgrids::dperb::dPERBydx)) -
       SIXTH * perturbedResult[Rec::b_xyy];
   perturbedResult[Rec::b_z] =
       HALF * (der_i1j2k1->at(fsgrids::dperb::dPERBydz) + der_i1j1k1->at(fsgrids::dperb::dPERBydz)) -
   ...
   perturbedResult[Rec::c_x] =
       HALF * (der_i1j1k2->at(fsgrids::dperb::dPERBzdx) + der_i1j1k1->at(fsgrids::dperb::dPERBzdx)) -
       SIXTH * perturbedResult[Rec::c_xzz];
   perturbedResult[Rec::c_y] =
       HALF * (der_i1j1k2->at(fsgrids::dperb::dPERBzdy) + der_i1j1k1->at(fsgrids::dperb::dPERBzdy)) -
   ...
   perturbedResult[Rec::a_x] = cep_i2j1k1->at(fsgrids::bfield::PERBX) - cep_i1j1k1->at(fsgrids::bfield::PERBX) -
                               TENTH * perturbedResult[Rec::a_xxx];
   perturbedResult[Rec::b_y] = cep_i1j2k1->at(fsgrids::bfield::PERBY) - cep_i1j1k1->at(fsgrids::bfield::PERBY) -
                               TENTH * perturbedResult[Rec::b_yyy];
   perturbedResult[Rec::c_z] = cep_i1j1k2->at(fsgrids::bfield::PERBZ) - cep_i1j1k1->at(fsgrids::bfield::PERBZ) -
                               TENTH * perturbedResult[Rec::c_zzz];
   ...
   perturbedResult[Rec::a_0] =
       HALF * (cep_i2j1k1->at(fsgrids::bfield::PERBX) + cep_i1j1k1->at(fsgrids::bfield::PERBX)) -
       SIXTH * perturbedResult[Rec::a_xx];
   perturbedResult[Rec::b_0] =
       HALF * (cep_i1j2k1->at(fsgrids::bfield::PERBY) + cep_i1j1k1->at(fsgrids::bfield::PERBY)) -
       SIXTH * perturbedResult[Rec::b_yy];
   perturbedResult[Rec::c_0] =
       HALF * (cep_i1j1k2->at(fsgrids::bfield::PERBZ) + cep_i1j1k1->at(fsgrids::bfield::PERBZ)) -
...
#pragma omp critical
   ...
   if (lfsc[0] == -1 || lfsc[1] == -1 || lfsc[2] == -1) {
      cerr << "interpolateCurlB: Trying to access nonlocal cell at " << x[0] << ", " << x[1] << ", " << x[2]
           << ", which would be local coordinate " << lfsc[0] << ", " << lfsc[1] << ", " << lfsc[2] << endl;
      return {0, 0, 0};
   }
   ...
   for (int xoffset : {0, 1}) {
      for (int yoffset : {0, 1}) {
         for (int zoffset : {0, 1}) {
            ...
            Real coupling = abs(xoffset - (cell[0] - fsc[0])) * abs(yoffset - (cell[1] - fsc[1])) *
                            abs(zoffset - (cell[2] - fsc[2]));
