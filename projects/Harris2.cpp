...
//  creal epsilon0 = 8.85418781762e-12; // F/m
//  creal c = 299792458.0; // m/s
  
  //creal Vy0 = -B0 / (mu0 * q * DENSITY * SCA_LAMBDA * 5.0);
  creal Vy0 = 0.0;
  
//  creal Vy0 = -1.0 * c / SCA_LAMBDA * sqrt(epsilon0 * k * TEMPERATURE / (5.0 * DENSITY * pow(q, 2.0))); // m/s
//  creal mag_pot = -2.0 * k * TEMPERATURE / (q * Vy0) * log(cosh((x + 0.5 * dx) / SCA_LAMBDA)); // T m
