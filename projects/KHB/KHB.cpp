...
namespace projects {
   ...
   Real KHB::getDistribValue(creal& x, creal& z, creal& vx, creal& vy, creal& vz, const unsigned int popID) const {
   ...
   Real KHB::calcPhaseSpaceDensity(creal& x, creal& y, creal& z, creal& dx, creal& dy, creal& dz, creal& vx, creal& vy, creal& vz, creal& dvx, creal& dvy, creal& dvz,const unsigned int popID) const {   
