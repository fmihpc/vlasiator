...
\section{Purpose}
Produce random perturbations in density and velocity and let it relax in periodic boundary conditions. Available in one, two and three dimensions. General-purpose, low physical relevance test. Used for dispersion plots and conservation of $\nabla\cdot\mathbf{B}$ in my MSc thesis.
