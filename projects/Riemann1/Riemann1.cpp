   ...
   void Riemann1::setProjectBField(std::span<std::array<Real, fsgrids::bfield::N_BFIELD>> perb,
      ...
      if(!P::isRestart) {
         ...
         fsgrid.parallel_for([](int timerId) -> phiprof::Timer { return phiprof::Timer{timerId}; },
            ...
            cell[fsgrids::bfield::PERBX] = (xyz[0] < 0.0) ? Bx_l[LEFT_l] : Bx[RIGHT_l];
            cell[fsgrids::bfield::PERBY] = (xyz[0] < 0.0) ? By_l[LEFT_l] : By[RIGHT_l];
            cell[fsgrids::bfield::PERBZ] = (xyz[0] < 0.0) ? Bz_l[LEFT_l] : Bz[RIGHT_l];
         });
      }
   }
}
