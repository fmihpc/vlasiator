...
template <typename ITEM> class ItemStorage {
public:
...
template <typename ITEM> inline bool ItemStorage<ITEM>::get(const std::string& name, ITEM& item) const {
...
template <typename ITEM> inline bool ItemStorage<ITEM>::store(const std::string& name, ITEM item) {
