...
namespace FieldTracing {
   ...
   template <typename REAL> bool bulirschStoerStep(
      std::array<REAL, 3>& r, std::array<REAL, 3>& b, REAL& stepSize, const REAL minStepSize, const REAL maxStepSize, TracingFieldFunction<REAL>& BFieldFunction, const bool outwards = true
   ) {
