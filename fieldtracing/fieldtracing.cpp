 ...
 */
void reduceData(FsGrid<fsgrids::technical, FS_STENCIL_WIDTH>& technicalGrid,
 ...
 */
void traceOpenClosedConnection(FsGrid<fsgrids::technical, FS_STENCIL_WIDTH>& technicalGrid,
                               FsGrid<std::array<Real, fsgrids::bfield::N_BFIELD>, FS_STENCIL_WIDTH>& perBGrid,
                               FsGrid<std::array<Real, fsgrids::dperb::N_DPERB>, FS_STENCIL_WIDTH>& dPerBGrid,
                               std::vector<SBC::SphericalTriGrid::Node>& nodes) {
   ...
   uint64_t maxTracingSteps =
       8 * (gridSize[0] * technicalGrid.DX + gridSize[1] * technicalGrid.DY + gridSize[2] * technicalGrid.DZ) /
       stepSize;
 ...
 */
void traceFullBoxConnectionAndFluxRopes(FsGrid<fsgrids::technical, FS_STENCIL_WIDTH>& technicalGrid,
                                        FsGrid<std::array<Real, fsgrids::bfield::N_BFIELD>, FS_STENCIL_WIDTH>& perBGrid,
                                        FsGrid<std::array<Real, fsgrids::dperb::N_DPERB>, FS_STENCIL_WIDTH>& dPerBGrid,
                                        dccrg::Dccrg<SpatialCell, dccrg::Cartesian_Geometry>& mpiGrid) {
   ...
   const TReal maxTracingDistance =
       fieldTracingParameters.fullbox_and_fluxrope_max_distance > 0
