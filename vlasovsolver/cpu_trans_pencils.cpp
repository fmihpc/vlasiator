...
#pragma omp critical
   ...
   DimensionPencils[dimension].gpu_lengthOfPencils->optimizeGPU(stream,true);
   DimensionPencils[dimension].gpu_idsStart->optimizeGPU(stream,true);
   DimensionPencils[dimension].gpu_sourceDZ->optimizeGPU(stream,true);
   DimensionPencils[dimension].gpu_targetRatios->optimizeGPU(stream,true);
   // SLOW ON AMD:
