...
static ARCH_DEV inline Realf slope_limiter_amr(const Realf l, const Realf m, const Realf r, const Realf dx_left, const Realf dx_rght) { return slope_limiter_minmod_amr(l, m, r, dx_left, dx_rght); }
