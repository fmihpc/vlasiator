...
#ifndef CPU_ACC_MAP_SPLINES_H
#define CPU_ACC_MAP_SPLINES_H
...
*/
inline void copy_column_data(SpatialCell* spatial_cell, uint blockID,Real * __restrict__ values, int dimension){
