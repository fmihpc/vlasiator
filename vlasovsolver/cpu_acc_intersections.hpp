...
void compute_intersections_1st(const spatial_cell::SpatialCell* spatial_cell,
...
void compute_intersections_2nd(const spatial_cell::SpatialCell* spatial_cell,
                               const Eigen::Transform<Real,3,Eigen::Affine>& bwd_transform,
                               const Eigen::Transform<Real,3,Eigen::Affine>& fwd_transform,
                               uint dimension,
                               Real& intersection,Real& intersection_di,
...
void compute_intersections_3rd(const spatial_cell::SpatialCell* spatial_cell,
                               const Eigen::Transform<Real,3,Eigen::Affine>& bwd_transform,
                               const Eigen::Transform<Real,3,Eigen::Affine>& fwd_transform,
                               uint dimension,
                               Real& intersection,Real& intersection_di,
