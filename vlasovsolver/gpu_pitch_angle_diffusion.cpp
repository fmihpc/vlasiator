...
__global__ void
__launch_bounds__(Hashinator::defaults::MAX_BLOCKSIZE / 2) dividefByCount_kernel(size_t* dev_smallCellIdxArray, Realf* dev_fmu, int* dev_fcount, int nbins_v, int nbins_mu, int maxThreadIndex) {
...
__global__ void __launch_bounds__(Hashinator::defaults::MAX_BLOCKSIZE / 2) getCellIndexArray_kernel(
   size_t* dev_cellIdxArray, size_t* dev_velocityIdxArray, size_t* dev_cellIdxStartCutoff, int numberOfComputedVelocityBlocks, int maxCellIndex
) {
