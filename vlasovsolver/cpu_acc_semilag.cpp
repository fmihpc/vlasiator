...
void prepareAccelerateCell(SpatialCell* spatial_cell, const uint popID) {
...
void cpu_accelerate_cell(SpatialCell* spatial_cell, const uint popID, const uint map_order, const Real& dt) {
   // double t1 = MPI_Wtime();
