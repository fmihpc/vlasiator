...
static inline Vec4Simple<T> abs(const Vec4Simple<T> &l){
   return Vec4Simple<T>(fabs(l.val[0]),
                    fabs(l.val[1]),
                    fabs(l.val[2]),
                    fabs(l.val[3]));
}
...
static inline Vec4Simple<T> operator + (const Vec4Simple<T> &l, const Vec4Simple<T> &r){
   return Vec4Simple<T>(l.val[0]+r.val[0],
                      l.val[1]+r.val[1],
                      l.val[2]+r.val[2],
                      l.val[3]+r.val[3]);
}
...
template <class T>
static inline Vec4Simple<T> operator - (const T &l, const Vec4Simple<T> &r){
   return Vec4Simple<T>(l-r.val[0],
                      l-r.val[1],
                      l-r.val[2],
                      l-r.val[3]);
...
template <class T>
static inline Vec4Simple<T> operator - (const Vec4Simple<T> &l, const T &r){
   return Vec4Simple<T>(l.val[0]-r,
                      l.val[1]-r,
                      l.val[2]-r,
                      l.val[3]-r);
...
{
   return Vec4Simple<bool>(l.val[0] || r.val[0],
                    l.val[1] || r.val[1],
                    l.val[2] || r.val[2],
                    l.val[3] || r.val[3]);
}
...
{
   return Vec4Simple<bool>(l.val[0] > r,
			   l.val[1] > r,
			   l.val[2] > r,
			   l.val[3] > r);
}
...
{
   return Vec4Simple<bool>(l > r.val[0],
			   l > r.val[1],
			   l > r.val[2],
			   l > r.val[3]);
}
