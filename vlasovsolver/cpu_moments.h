...
template <typename REAL> void blockVelocityFirstMoments(const Realf* avgs, const Real* blockParams, REAL* array);
...
template <typename REAL>
inline void blockVelocityFirstMoments(const Realf* avgs, const Real* blockParams, REAL* array) {
